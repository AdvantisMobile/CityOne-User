...
class _HomeWidgetState extends StateMVC<HomeWidget> {
  ...
  TextStyle _titleStyle = TextStyle(color: Colors.black54, fontWeight: FontWeight.bold, fontSize: 20);
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Center(
                    child:currentUser.value.apiToken != null ? Text('Hola: ${currentUser.value.name}', style: _titleStyle,) :
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text('Saldo: 20.000 COP', style: _titleStyle,),
                    ],
                  ),
                ),
              ),
