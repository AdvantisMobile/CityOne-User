...
import 'package:markets/src/pages/cab/cab_pages.dart';
import 'package:markets/src/pages/cab/payment_cab.dart';
import 'package:markets/src/pages/cab/transaction_cab.dart';
import 'package:markets/src/pages/cashback/cashback_pages.dart';
import 'package:markets/src/pages/cashback/recharge_cashback.dart';
import 'package:markets/src/pages/map_delivery.dart';
import 'package:markets/src/pages/redeban_payment.dart';
import 'package:markets/src/pages/select_type_drive.dart';
import 'package:markets/src/pages/shipment/shipment_pages.dart';
import 'package:markets/src/pages/users_refer.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/cashbak':
        return MaterialPageRoute(builder: (_) => CashBackPages(currentTab: args));
      case '/cab':
        return MaterialPageRoute(builder: (_) => CabPages(currentTab: args));
      case '/shipment':
        return MaterialPageRoute(builder: (_) => ShipmentPages(currentTab: args));
      case '/Details':
      ...
      case '/Redeban':
        return MaterialPageRoute(builder: (_) => RedebanPaymentWidget(routeArgument: args as RouteArgument));
      case '/Settings':
        return MaterialPageRoute(builder: (_) => SettingsWidget());
      case '/Recharge':
        return MaterialPageRoute(builder: (_) => RechargeCashBack());
      case '/SelectTypeDrive':
        return MaterialPageRoute(builder: (_) => SelectTypeDrive());
      case '/TransactionCab':
        return MaterialPageRoute(builder: (_) => TransactionCab(routeArgument: args as RouteArgument));
      case '/PaymentTrip':
        return MaterialPageRoute(builder: (_) => PaymentCabWidget(routeArgument: args as RouteArgument));
      case '/Referidos':
        return MaterialPageRoute(builder: (_) => UsersReferWidget());
      case '/MapDelivery':
        return MaterialPageRoute(builder: (_) => MapDeliveryWidget(routeArgument: args as RouteArgument));
      default:
